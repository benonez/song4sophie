...
float myscale=.5, var1=.00001, amp_r=3, amp_g=3, amp_b=3, jumpto=0, moviespeed=1, speed_r, speed_g, speed_b, lfo_r, lfo_g, lfo_b;
float decay=.75, decay2=.0000001, amp_r_saved, amp_g_saved, amp_b_saved, speed_r_saved, speed_g_saved, speed_b_saved;
